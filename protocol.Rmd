...
- Action steps:
    ...
    - How to evaluate/code sources
        ...
        - This will populate the Google Sheet [motion-metaanalysis (Responses)](https://docs.google.com/spreadsheets/d/1K0TEzdSXl7GTFg2-vDHvndVvxOHLRvXdgZWVDNyvPLM/edit#gid=1643485482) 
...
## How to find papers from google drive
-Open google drive <https://drive.google.com>
-Logged in to your gmail account (not psu account) 
-Click on "Shared with me" in the left hand side
-Find a folder named "Paperpile"
-Open "All papers" folder (The alphabet letter folder is organized with author's last name) 
-Serch your article from author's last name OR type your article's name in the "search drive"
-ex: "temporal coding for visual space" (upper case or lower case won't effect, but adding quotation mark at the beginning and ending of the article title can help google drive to narrow down the search)  
-You can either download it or view it directly to code the paper (whatever way you preferred) 


**Notes

format images like:
![ImageName](img/ImageName.extension)

formate weblinks like: 
[Name for link](https://link address)
## Coding steps

The coding spreadsheet is located here: <https://docs.google.com/spreadsheets/d/1MD2MM22b5iWwHatBSBiqvU265KaEsC7-Xa-HBTIEO-Y/edit#gid=0>
...
Enter one of the following single letter codes to describe the type of the paper.
...
If a paper is coded as `R`, we do not need to complete the rest of the codes about the tasks or participant demographics.
Also, papers coded `R` are excluded, and must be coded as excluded by...
